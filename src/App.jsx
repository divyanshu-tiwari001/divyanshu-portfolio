        ...
        <section id="home" className="relative pt-32 pb-20 px-6 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto text-center relative z-10">
            ...
            <p className={`text-xl md:text-2xl mb-12 max-w-3xl mx-auto font-poppins animate-slide-bottom ${isDark ? 'text-slate-300' : 'text-slate-600'}`} style={{ animationDelay: '0.2s' }}>
              A passionate student developer from Motihari, Bihar, blending creative writing excellence with cutting-edge technical skills and AI-powered innovation.
            </p>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
              {[
                ...
                { name: 'Netlify', icon: '🚀' }, { name: 'VS Code', icon: '💻' }, { name: 'Claude', icon: '🧠' }
              ].map((tech, index) => (
