        ...
        <section id="experience" className="py-24 px-6 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="text-center mb-16">
              ...
              <p className={`text-xl max-w-2xl mx-auto font-poppins ${isDark ? 'text-slate-300' : 'text-slate-600'}`}>
                Building real-world experience through diverse opportunities
              </p>
            </div>

            <div className="max-w-4xl mx-auto space-y-8">
              {/* Experience 1: Social Media Manager at EM AUR */}
              <div className={`group relative p-10 rounded-3xl backdrop-blur-xl border hover:scale-[1.02] hover:-translate-y-2 transition-all duration-500 shadow-xl hover:shadow-2xl hover:shadow-orange-500/30 ${isDark ? 'bg-slate-900/50 border-slate-800 hover:border-orange-500/50' : 'bg-white/50 border-slate-200 hover:border-orange-500/50'}`}>
              ...
              <div className={`group relative p-10 rounded-3xl backdrop-blur-xl border hover:scale-[1.02] hover:-translate-y-2 transition-all duration-500 shadow-xl hover:shadow-2xl hover:shadow-orange-500/30 ${isDark ? 'bg-slate-900/50 border-slate-800 hover:border-orange-500/50' : 'bg-white/50 border-slate-200 hover:border-orange-500/50'}`}>
                ...
                <div className="flex items-start gap-6 mb-6">
                  <div className="relative">
                    <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-orange-500 to-red-600 flex items-center justify-center group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 shadow-lg">
              ...
              <div className={`group relative p-10 rounded-3xl backdrop-blur-xl border hover:scale-[1.02] hover:-translate-y-2 transition-all duration-500 shadow-xl hover:shadow-2xl hover:shadow-blue-500/30 ${isDark ? 'bg-slate-900/50 border-slate-800 hover:border-blue-500/50' : 'bg-white/50 border-slate-200 hover:border-blue-500/50'}`}>
                
                <div className="flex items-start gap-6 mb-6">
                  <div className="relative">
                    <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-blue-500 to-cyan-600 flex items-center justify-center group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 shadow-lg">
                      <GraduationCap className="w-10 h-10 text-white" />
                    </div>
                    <div className="absolute -top-2 -right-2 w-6 h-6 bg-green-500 rounded-full border-4 border-white dark:border-slate-900 animate-pulse"></div>
                  </div>
                  ...
                  <div className="flex-1">
                    ...
                    <div className={`text-xl font-semibold mb-2 ${isDark ? 'text-blue-400' : 'text-blue-600'}`}>
                      Scaler School Of Technology
                    </div>
                    <div className={`text-sm font-semibold mb-4 ${isDark ? 'text-slate-400' : 'text-slate-600'}`}>
              ...
              <div className={`group relative p-10 rounded-3xl backdrop-blur-xl border hover:scale-[1.02] transition-all duration-500 shadow-xl hover:shadow-2xl hover:shadow-amber-500/30 ${isDark ? 'bg-slate-900/50 border-slate-800 hover:border-amber-500/50' : 'bg-white/50 border-slate-200 hover:border-amber-500/50'}`}>
                <div className={`p-6 rounded-2xl border-2 border-dashed ${isDark ? 'border-slate-700 bg-slate-800/30' : 'border-slate-300 bg-slate-50'}`}>
